...
const headerContent = `import { useState, useRef, useEffect } from "react";
...
const sellerSidebarContent = \`import { Link, useLocation } from "react-router-dom";
...
fs.writeFileSync(path.join('src', 'components', 'layout', 'Header.tsx'), headerContent);
fs.writeFileSync(path.join('src', 'components', 'seller', 'SellerSidebar.tsx'), sellerSidebarContent);
